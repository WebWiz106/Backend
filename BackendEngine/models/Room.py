...
from models.changedprice import ChangedPrice

class Room:
    def __init__(self, hId, jiniId, roomType, roomName, roomDescription, roomSubheading, child, adult, noOfRooms, roomTypeName, price, isWeekendFormat, changedPrice, roomImage,roomFacilities,roomNumbers,inMaintanance,roomTag):
        self.hId = hId
        self.jiniId = jiniId
